...
export interface IDSProxyRegistryInterface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic: "build()" | "build(address)" | "proxies"
  ): FunctionFragment;
...
export interface IDSProxyRegistry extends BaseContract {
