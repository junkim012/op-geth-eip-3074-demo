...
export interface PortalWrappedTokenInterface extends utils.Interface {
  functions: {
...
export interface PortalWrappedToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: PortalWrappedTokenInterface;
